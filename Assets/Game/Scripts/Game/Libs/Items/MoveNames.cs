namespace Game.Libs.Items
{
    public static class MoveNames
    {
        ...
        public const string MAP_HOLD = "map_hold";
        public const string MAP_LOWER = "map_lower";
    }

    // in general move type id is the same as move id,
    // but for attacks there can be multiple of them, so there's a need for an explicit move type id
    public static class MoveTypeIds
    {
        public const string ATTACK_PREPARE = "attack_prepare";
        public const string ATTACK_EXECUTE = "attack_execute";
        public const string ATTACK_TRANSITION = "attack_transition";
        public const string ATTACK_RECOVER = "attack_recover";
    }
}